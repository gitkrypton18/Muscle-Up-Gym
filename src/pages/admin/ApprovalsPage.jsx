            ...
            {mediaFile && mediaFile.type.startsWith('video') && (
              <div className="flex-1 space-y-2 w-full">
                ...
                <select 
                  ...
                  className="w-full h-14 rounded-md border border-input bg-background/50 px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
                >
              ...
              <Card key={m.id} className="bg-card overflow-hidden">
                <div className="aspect-square bg-muted relative flex items-center justify-center p-2">
                  ...
                  {m.category && m.category !== 'general' && (
                    <div className="absolute top-4 right-4 bg-primary px-2 py-1 rounded text-xs text-black font-extrabold shadow-md">
